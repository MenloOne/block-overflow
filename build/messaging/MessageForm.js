...
var MessageForm = /** @class */ (function (_super) {
    tslib_1.__extends(MessageForm, _super);
    ...
    MessageForm.prototype.componentWillReceiveProps = function (newProps) {
        this.refreshForum(newProps);
    };
    MessageForm.prototype.refreshForum = function (newProps) {
    ...
    MessageForm.prototype.onSubmit = function (event) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
    ...
    MessageForm.prototype.onChange = function (event) {
        this.setState({ message: event.target.value });
    };
    MessageForm.prototype.onCancel = function () {
...
exports.default = AccountService_1.withAcct(MessageForm);
